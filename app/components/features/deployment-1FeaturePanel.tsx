...
interface Deployment1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Deployment1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Deployment1FeaturePanel.displayName = 'Deployment1FeaturePanel';
