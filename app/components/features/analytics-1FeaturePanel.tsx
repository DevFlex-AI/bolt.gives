...
interface Analytics1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Analytics1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Analytics1FeaturePanel.displayName = 'Analytics1FeaturePanel';
