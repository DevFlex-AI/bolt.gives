...
interface Documentation1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Documentation1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
  ...
  onSort,
  features,
}: Documentation1FeaturePanelProps) => {
...
Documentation1FeaturePanel.displayName = 'Documentation1FeaturePanel';
