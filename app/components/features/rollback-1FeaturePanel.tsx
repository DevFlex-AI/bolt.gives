...
interface Rollback1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Rollback1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Rollback1FeaturePanel.displayName = 'Rollback1FeaturePanel';
