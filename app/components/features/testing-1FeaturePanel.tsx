...
interface Testing1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Testing1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Testing1FeaturePanel.displayName = 'Testing1FeaturePanel';
