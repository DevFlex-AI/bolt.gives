...
interface Restore1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Restore1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Restore1FeaturePanel.displayName = 'Restore1FeaturePanel';
