...
interface Loadbalancer1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Loadbalancer1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
  ...
  onSort,
  features,
}: Loadbalancer1FeaturePanelProps) => {
...
Loadbalancer1FeaturePanel.displayName = 'Loadbalancer1FeaturePanel';
