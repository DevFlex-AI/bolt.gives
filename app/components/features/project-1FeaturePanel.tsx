...
interface Project1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Project1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Project1FeaturePanel.displayName = 'Project1FeaturePanel';
