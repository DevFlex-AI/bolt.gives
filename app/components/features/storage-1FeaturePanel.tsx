...
interface Storage1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Storage1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Storage1FeaturePanel.displayName = 'Storage1FeaturePanel';
