...
interface Migration1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Migration1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Migration1FeaturePanel.displayName = 'Migration1FeaturePanel';
