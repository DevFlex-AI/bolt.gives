...
interface Collaboration1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Collaboration1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
  ...
  onSort,
  features,
}: Collaboration1FeaturePanelProps) => {
...
Collaboration1FeaturePanel.displayName = 'Collaboration1FeaturePanel';
