...
interface Billing1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Billing1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Billing1FeaturePanel.displayName = 'Billing1FeaturePanel';
