...
interface Release1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Release1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Release1FeaturePanel.displayName = 'Release1FeaturePanel';
