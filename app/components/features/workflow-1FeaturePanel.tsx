...
interface Workflow1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Workflow1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Workflow1FeaturePanel.displayName = 'Workflow1FeaturePanel';
