...
interface Security1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Security1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Security1FeaturePanel.displayName = 'Security1FeaturePanel';
