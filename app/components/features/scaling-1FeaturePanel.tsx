...
interface Scaling1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Scaling1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Scaling1FeaturePanel.displayName = 'Scaling1FeaturePanel';
