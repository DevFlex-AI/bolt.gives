...
interface Executor1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Executor1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Executor1FeaturePanel.displayName = 'Executor1FeaturePanel';
