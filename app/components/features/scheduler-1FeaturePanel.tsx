...
interface Scheduler1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Scheduler1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Scheduler1FeaturePanel.displayName = 'Scheduler1FeaturePanel';
