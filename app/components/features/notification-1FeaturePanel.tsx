...
interface Notification1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Notification1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
  ...
  onSort,
  features,
}: Notification1FeaturePanelProps) => {
...
Notification1FeaturePanel.displayName = 'Notification1FeaturePanel';
