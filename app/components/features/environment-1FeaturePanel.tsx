...
interface Environment1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Environment1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Environment1FeaturePanel.displayName = 'Environment1FeaturePanel';
