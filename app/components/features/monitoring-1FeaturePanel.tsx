...
interface Monitoring1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Monitoring1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Monitoring1FeaturePanel.displayName = 'Monitoring1FeaturePanel';
