...
interface Pipeline1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Pipeline1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Pipeline1FeaturePanel.displayName = 'Pipeline1FeaturePanel';
