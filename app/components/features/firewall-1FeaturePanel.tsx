...
interface Firewall1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Firewall1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Firewall1FeaturePanel.displayName = 'Firewall1FeaturePanel';
