...
interface Database1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Database1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Database1FeaturePanel.displayName = 'Database1FeaturePanel';
