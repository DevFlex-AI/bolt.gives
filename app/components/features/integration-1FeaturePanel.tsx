...
interface Integration1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Integration1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Integration1FeaturePanel.displayName = 'Integration1FeaturePanel';
