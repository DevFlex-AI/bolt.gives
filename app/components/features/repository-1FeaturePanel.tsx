...
interface Repository1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Repository1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Repository1FeaturePanel.displayName = 'Repository1FeaturePanel';
