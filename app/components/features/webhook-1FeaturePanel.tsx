...
interface Webhook1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Webhook1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Webhook1FeaturePanel.displayName = 'Webhook1FeaturePanel';
