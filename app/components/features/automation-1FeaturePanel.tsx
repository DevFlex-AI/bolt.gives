...
interface Automation1FeaturePanelProps {
  data: any[];
  viewMode: 'grid' | 'list';
...
export const Automation1FeaturePanel = memo(({
  data,
  viewMode,
  selectedItems,
  onSelectItem,
...
Automation1FeaturePanel.displayName = 'Automation1FeaturePanel';
